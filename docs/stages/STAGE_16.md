...
Agent/tool/model telemetry: latency, tokens, evidence IDs, errors.

## 3. Why are we building it?

You can't improve or audit what you can't see.
...
**Simple:** See [GLOSSARY.md](../GLOSSARY.md) for `Trace` if listed; otherwise learn it while implementing this stage.

### Span

**Simple:** See [GLOSSARY.md](../GLOSSARY.md) for `Span` if listed; otherwise learn it while implementing this stage.

### Token usage

**Simple:** See [GLOSSARY.md](../GLOSSARY.md) for `Token usage` if listed; otherwise learn it while implementing this stage.


## 6. Technologies used

Primary stack for this stage: **structlog, OpenTelemetry concepts**
...
Inputs from earlier stages
        ↓
Stage 16 processing (Observability)
        ↓
...
- This document: `docs/stages/STAGE_16.md`
...
1. What is Stage 16 trying to produce?
...
1. “It produces observability capabilities that later stages consume.”
...
“Stage 16 is Observability. It isn't built yet in the repo. When we implement it, it will sit in the pipeline between earlier data/platform work and later recommendation/governance stages.”

## 19. 2-minute explanation

“In the full project design, Stage 16 exists because You can't improve or audit what you can't see. Today the status is planned only — I'm careful not to claim it in interviews as shipped. The learning goal is to understand the problem it solves: Opaque AI runs. Technologies we expect: structlog, OpenTelemetry concepts.”
...
- Status: **PLANNED**
- Goal: Agent/tool/model telemetry: latency, tokens, evidence IDs, errors.
- Why: You can't improve or audit what you can't see.
- Key tech: structlog, OpenTelemetry concepts
