...
Enterprise-style pages: portfolio, graph, roadmap, approvals — not a giant chatbot.

## 3. Why are we building it?

Architects need explainable UI over evidence and decisions.

## 4. What problem does it solve?

Flashy AI skins without tables/graphs.

## 5. Concepts I need to understand first

### Dashboard information architecture

**Simple:** See [GLOSSARY.md](../GLOSSARY.md) for `Dashboard information architecture` if listed; otherwise learn it while implementing this stage.

### Graph visualization

**Simple:** See [GLOSSARY.md](../GLOSSARY.md) for `Graph visualization` if listed; otherwise learn it while implementing this stage.


## 6. Technologies used

Primary stack for this stage: **Streamlit**

### Streamlit

- **What it is:** Internal UI

- **Why we use it:** Fits this stage's problem without overengineering.

- **How we use it:** Rapid console
...
Inputs from earlier stages
        ↓
Stage 17 processing (Enterprise Streamlit Console)
        ↓
...
- This document: `docs/stages/STAGE_17.md`
...
1. What is Stage 17 trying to produce?
...
1. “It produces enterprise streamlit console capabilities that later stages consume.”
...
“Stage 17 is Enterprise Streamlit Console. It isn't built yet in the repo. When we implement it, it will sit in the pipeline between earlier data/platform work and later recommendation/governance stages.”

## 19. 2-minute explanation

“In the full project design, Stage 17 exists because Architects need explainable UI over evidence and decisions. Today the status is planned only — I'm careful not to claim it in interviews as shipped. The learning goal is to understand the problem it solves: Flashy AI skins without tables/graphs. Technologies we expect: Streamlit.”
...
- Status: **PLANNED**
- Goal: Enterprise-style pages: portfolio, graph, roadmap, approvals — not a giant chatbot.
- Why: Architects need explainable UI over evidence and decisions.
- Key tech: Streamlit
