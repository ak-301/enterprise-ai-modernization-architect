...
20+ scenarios measuring strategy, grounding, RAG, risk, cost, policy, hallucination.

## 3. Why are we building it?

Demo vibes are not quality evidence.

## 4. What problem does it solve?

Claiming accuracy without measurement.

## 5. Concepts I need to understand first

### Golden set

**Simple:** See [GLOSSARY.md](../GLOSSARY.md) for `Golden set` if listed; otherwise learn it while implementing this stage.

### Precision/recall

**Simple:** See [GLOSSARY.md](../GLOSSARY.md) for `Precision/recall` if listed; otherwise learn it while implementing this stage.

### Hallucination rate

**Simple:** See [GLOSSARY.md](../GLOSSARY.md) for `Hallucination rate` if listed; otherwise learn it while implementing this stage.


## 6. Technologies used

Primary stack for this stage: **pytest, golden scenarios**
...
- **How we use it:** Regression evals
...
Inputs from earlier stages
        ↓
Stage 14 processing (Evaluation Framework)
        ↓
...
- This document: `docs/stages/STAGE_14.md`
...
1. What is Stage 14 trying to produce?
...
1. “It produces evaluation framework capabilities that later stages consume.”
...
“Stage 14 is Evaluation Framework. It isn't built yet in the repo. When we implement it, it will sit in the pipeline between earlier data/platform work and later recommendation/governance stages.”

## 19. 2-minute explanation

“In the full project design, Stage 14 exists because Demo vibes are not quality evidence. Today the status is planned only — I'm careful not to claim it in interviews as shipped. The learning goal is to understand the problem it solves: Claiming accuracy without measurement. Technologies we expect: pytest, golden scenarios.”
...
- Status: **PLANNED**
- Goal: 20+ scenarios measuring strategy, grounding, RAG, risk, cost, policy, hallucination.
- Why: Demo vibes are not quality evidence.
- Key tech: pytest, golden scenarios
