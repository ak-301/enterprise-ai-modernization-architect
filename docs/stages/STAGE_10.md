...
Dependency-aware waves with prerequisites, blockers, and rationale.

## 3. Why are we building it?

Wrong order causes outages; waves encode constraints.

## 4. What problem does it solve?

Alphabetical or random sequencing.

## 5. Concepts I need to understand first

### Wave

**Simple:** See [GLOSSARY.md](../GLOSSARY.md) for `Wave` if listed; otherwise learn it while implementing this stage.

### Prerequisite

**Simple:** See [GLOSSARY.md](../GLOSSARY.md) for `Prerequisite` if listed; otherwise learn it while implementing this stage.

### Blocker

**Simple:** See [GLOSSARY.md](../GLOSSARY.md) for `Blocker` if listed; otherwise learn it while implementing this stage.

### Readiness

**Simple:** See [GLOSSARY.md](../GLOSSARY.md) for `Readiness` if listed; otherwise learn it while implementing this stage.


## 6. Technologies used

Primary stack for this stage: **NetworkX + rules**
...
- **How we use it:** Explainable waves
...
Inputs from earlier stages
        ↓
Stage 10 processing (Migration Wave Planner)
        ↓
...
- This document: `docs/stages/STAGE_10.md`
...
1. What is Stage 10 trying to produce?
...
1. “It produces migration wave planner capabilities that later stages consume.”
...
“Stage 10 is Migration Wave Planner. It isn't built yet in the repo. When we implement it, it will sit in the pipeline between earlier data/platform work and later recommendation/governance stages.”

## 19. 2-minute explanation

“In the full project design, Stage 10 exists because Wrong order causes outages; waves encode constraints. Today the status is planned only — I'm careful not to claim it in interviews as shipped. The learning goal is to understand the problem it solves: Alphabetical or random sequencing. Technologies we expect: NetworkX + rules.”
...
- Status: **PLANNED**
- Goal: Dependency-aware waves with prerequisites, blockers, and rationale.
- Why: Wrong order causes outages; waves encode constraints.
- Key tech: NetworkX + rules
