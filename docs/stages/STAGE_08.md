...
Multi-dimension risk with likelihood, impact, score, evidence, mitigation.

## 3. Why are we building it?

Architects need comparable risk language across apps.

## 4. What problem does it solve?

Vague 'this feels risky' without methodology.

## 5. Concepts I need to understand first

### Likelihood

**Simple:** See [GLOSSARY.md](../GLOSSARY.md) for `Likelihood` if listed; otherwise learn it while implementing this stage.

### Impact

**Simple:** See [GLOSSARY.md](../GLOSSARY.md) for `Impact` if listed; otherwise learn it while implementing this stage.

### Risk category

**Simple:** See [GLOSSARY.md](../GLOSSARY.md) for `Risk category` if listed; otherwise learn it while implementing this stage.

### Mitigation

**Simple:** See [GLOSSARY.md](../GLOSSARY.md) for `Mitigation` if listed; otherwise learn it while implementing this stage.


## 6. Technologies used

Primary stack for this stage: **Python**
...
- **How we use it:** Documented formula
...
Inputs from earlier stages
        ↓
Stage 8 processing (Risk Engine)
        ↓
...
- This document: `docs/stages/STAGE_08.md`
...
1. What is Stage 8 trying to produce?
...
1. “It produces risk engine capabilities that later stages consume.”
...
“Stage 8 is Risk Engine. It isn't built yet in the repo. When we implement it, it will sit in the pipeline between earlier data/platform work and later recommendation/governance stages.”

## 19. 2-minute explanation

“In the full project design, Stage 8 exists because Architects need comparable risk language across apps. Today the status is planned only — I'm careful not to claim it in interviews as shipped. The learning goal is to understand the problem it solves: Vague 'this feels risky' without methodology. Technologies we expect: Python.”
...
- Status: **PLANNED**
- Goal: Multi-dimension risk with likelihood, impact, score, evidence, mitigation.
- Why: Architects need comparable risk language across apps.
- Key tech: Python
