...
Automate lint, tests, type checks, build, security checks.

## 3. Why are we building it?

Prevent regressions as AI and pipelines evolve.

## 4. What problem does it solve?

Manual 'it worked on my machine'.

## 5. Concepts I need to understand first

### Pipeline

**Simple:** See [GLOSSARY.md](../GLOSSARY.md) for `Pipeline` if listed; otherwise learn it while implementing this stage.

### Gate

**Simple:** See [GLOSSARY.md](../GLOSSARY.md) for `Gate` if listed; otherwise learn it while implementing this stage.

### Artifact

**Simple:** See [GLOSSARY.md](../GLOSSARY.md) for `Artifact` if listed; otherwise learn it while implementing this stage.


## 6. Technologies used

Primary stack for this stage: **GitHub Actions**
...
- This document: `docs/stages/STAGE_18.md`
...
1. What is Stage 18 trying to produce?
...
1. “It produces ci/cd capabilities that later stages consume.”
...
“Stage 18 is CI/CD. It isn't built yet in the repo. When we implement it, it will sit in the pipeline between earlier data/platform work and later recommendation/governance stages.”

## 19. 2-minute explanation

“In the full project design, Stage 18 exists because Prevent regressions as AI and pipelines evolve. Today the status is planned only — I'm careful not to claim it in interviews as shipped. The learning goal is to understand the problem it solves: Manual 'it worked on my machine'. Technologies we expect: GitHub Actions.”
...
- Status: **PLANNED**
- Goal: Automate lint, tests, type checks, build, security checks.
- Why: Prevent regressions as AI and pipelines evolve.
- Key tech: GitHub Actions
