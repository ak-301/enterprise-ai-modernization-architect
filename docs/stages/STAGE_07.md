# Stage 07 — Modernization Analysis Engine
...
Deterministic scoring and candidate 6R (+Replace) strategies with evidence hooks.

## 3. Why are we building it?

Strategy choice needs transparent factors, not vibes.

## 4. What problem does it solve?

Black-box 'the model said replatform'.

## 5. Concepts I need to understand first

### 6 Rs

**Simple:** See [GLOSSARY.md](../GLOSSARY.md) for `6 Rs` if listed; otherwise learn it while implementing this stage.

### Technical debt

**Simple:** See [GLOSSARY.md](../GLOSSARY.md) for `Technical debt` if listed; otherwise learn it while implementing this stage.

### Cloud readiness

**Simple:** See [GLOSSARY.md](../GLOSSARY.md) for `Cloud readiness` if listed; otherwise learn it while implementing this stage.

### Weighted score

**Simple:** See [GLOSSARY.md](../GLOSSARY.md) for `Weighted score` if listed; otherwise learn it while implementing this stage.


## 6. Technologies used

Primary stack for this stage: **Python rules + scoring**

### Pure Python modules

- **What it is:** Deterministic logic

- **Why we use it:** Fits this stage's problem without overengineering.

- **How we use it:** Testable scoring
...
Inputs from earlier stages
        ↓
Stage 7 processing (Modernization Analysis Engine)
        ↓
...
- This document: `docs/stages/STAGE_07.md`
...
1. What is Stage 7 trying to produce?
...
1. “It produces modernization analysis engine capabilities that later stages consume.”
...
“Stage 7 is Modernization Analysis Engine. It isn't built yet in the repo. When we implement it, it will sit in the pipeline between earlier data/platform work and later recommendation/governance stages.”

## 19. 2-minute explanation

“In the full project design, Stage 7 exists because Strategy choice needs transparent factors, not vibes. Today the status is planned only — I'm careful not to claim it in interviews as shipped. The learning goal is to understand the problem it solves: Black-box 'the model said replatform'. Technologies we expect: Python rules + scoring.”
...
- Status: **PLANNED**
- Goal: Deterministic scoring and candidate 6R (+Replace) strategies with evidence hooks.
- Why: Strategy choice needs transparent factors, not vibes.
- Key tech: Python rules + scoring
